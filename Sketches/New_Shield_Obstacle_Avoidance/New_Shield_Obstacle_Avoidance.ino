/*First shot at obstacle avoidance with new SEEED motor driver
 */

 const int pingPin =     7;      //Ultrasonic sensor to pin D9
 const int in1Pin =      8;      //Left motor direction 1 to pin D8
 const int in2Pin =      11;     //Left motor direction 2 to pin D11
 const int in3Pin =      12;     //Right motor direction 1 to pin D12
 const int in4Pin =      13;     //Right motor direction 2 to pin D13
